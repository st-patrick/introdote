...
curl -s -X POST -u "api:$LIMACITY_API_KEY" \
  ...
  -d '{"email_address":{"local_part":"hello","domain":"blackforest-interiors.de","type":"alias","destinations":["patrickreinbold@gmail.com"]}}'

# Agent reports: "✓ Created hello@blackforest-interiors.de → forwards to your Gmail"
```
